...
function(BaseWidget, 
  ...
  return declare([BaseWidget], {
    ...
    getAndSortDateTimeValues: function(object, objectKey){
      return object.map(function(record){
        return record[objectKey]
     }).filter(lang.hitch(this, function(value, index, self){
       return self.indexOf(value) === index
     })).sort()
    },


    manageDateTime: function(object){
      var startOptions = this.getAndSortDateTimeValues(object, 'startDate').map(function(record){
        return domConstruct.create("option", {
          label: record,
          value: record,
          id: record
      ...
      var endOptions = this.getAndSortDateTimeValues(object, 'endDate').map(function(record){
        return domConstruct.create("option", {
          label: record,
          value: record,
          id: record
      ...
      var startSelect = dijit.byId("startSelect");
          startSelect.addOption(startOptions);
      ...
      var endSelect = dijit.byId("endSelect");
          endSelect.addOption(endOptions);
